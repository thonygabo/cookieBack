package com.cookie.cookie.utils;
...
public class Constantes {
	...
	public static final String MENSAJE_BU_NO_EXISTE_CORREO_CONTRASENIA = "No existe ningun correo registrado, vuelva ingresar";

	public static final String URL_PROYECTO="https://madeliyricra.github.io";
	//public static final String URL_PROYECTO = "http://localhost:4200";
}